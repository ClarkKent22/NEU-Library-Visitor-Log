...
<body class="theme-dark">
    ...
    <div class="kiosk-shell">
        <div class="kiosk-hero">
            ...
            <p class="text-muted mb-3">Enter your ID Number to generate a scannable QR code for quick access.</p>
        ...
        <div class="kiosk-card">
            ...
            <p class="text-muted small mb-4">Enter your ID Number to get your library pass</p>

            <form method="POST" id="searchForm">
                <div class="mb-3">
                    <label class="small fw-bold text-muted mb-1 d-block">Student / Employee ID</label>
                    <input type="text" name="userID" id="userID" 
                           class="form-control border-2" placeholder="ID Number" 
                           inputmode="numeric" maxlength="20" required style="border-radius: 10px;">
                </div>
