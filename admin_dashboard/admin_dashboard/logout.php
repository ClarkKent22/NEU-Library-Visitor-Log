...
$google_error_map = [
    'google_config' => 'Google login is not configured. Please contact the system administrator.',
    ...
    'token_error' => 'Unable to verify your Google sign-in. Please try again.',
    'missing_id_token' => 'Google sign-in failed. Please try again.',
    'invalid_audience' => 'Invalid Google token. Please try again.',
    'unverified_email' => 'Your Google email is not verified.',
    'not_allowed' => 'This Google account is not allowed to access the Admin Portal.',
    'no_account' => 'No matching admin account found for this email.',
    'blocked' => 'Your account is currently blocked. Please contact the Super Admin.',
    'not_admin' => 'Access Denied. This portal is for Administrators only.',
];

if (isset($_GET['error']) && isset($google_error_map[$_GET['error']])) {
    $error = $google_error_map[$_GET['error']];
}
...
<section class="auth-shell">
    ...
    <div class="auth-panel auth-form text-center">
            ...
            <div class="mb-3">
                <a href="google_auth_start.php" class="btn btn-light w-100 d-flex align-items-center justify-content-center gap-2 border" style="border-radius: 10px; font-weight: 700;">
