...
$user = $conn->query("SELECT * FROM $table WHERE $idCol = '$id'")->fetch_assoc();
        ...
        <div class="row g-3">
            ...
            <div class="col-12">
                ...
                <select name="role" class="form-select" required>
                    ...
                    <option value="Employee / Faculty" <?= ($user['role'] === 'Employee / Faculty') ? 'selected' : '' ?>>Employee / Faculty</option>
                    <option value="Faculty/Admin" <?= ($user['role'] === 'Faculty/Admin') ? 'selected' : '' ?>>Faculty/Admin</option>
                </select>
            </div>
